...
pub mod solutions {
    ...
    /// "down 3"    -> y position += 3
    /// "up 6"      -> y position -= 6
    pub fn find_position_depth_product(logs_input: &Vec<&str>) -> u32 {
        let mut x_pos = 0;
        let mut y_pos = 0;
    ...
    fn check_position_depth_product() {
        ...
        let actual = find_position_depth_product(&input);
    ...
    pub fn find_aimed_position_depth_product(logs_input: &Vec<&str>) -> u32 {
        let mut aim = 0;
        let mut x_pos = 0;
        let mut y_pos = 0;
    ...
    fn check_aimed_position_depth_product() {
        ...
        let actual = find_aimed_position_depth_product(&input);
